...
if __name__ == '__main__':
    ...
    parser.add_argument(
      '--output_graph',
      type=str,
      default=os.path.join(sys.path[0], 'retrain_graph/output_graph.pb'),
      help='Where to save the trained graph.'
  )
    parser.add_argument(
      '--output_labels',
      type=str,
      default=os.path.join(sys.path[0], 'retrain_graph/output_labels.txt'),
      help='Where to save the trained graph\'s labels.'
  )
    parser.add_argument(
      '--summaries_dir',
      type=str,
      default=os.path.join(sys.path[0], 'retrain_graph/retrain_logs'),
    ...
    parser.add_argument(
      '--model_dir',
      type=str,
      default=os.path.join(sys.path[0], 'retrain_graph/imagenet'),
      help="""\
    ...
    parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default=os.path.join(sys.path[0], 'retrain_graph/bottleneck'),
